...
typedef gpiodp_reconfigure_line_native_t = Int32 Function(Pointer<LineConfig> lineConfig);
typedef gpiodp_get_line_value_native_t = Int32 Function(Uint32 line_handle);
