...
typedef chip_num_lines_native_t = Int32 Function(Pointer<gpiod_chip> chip);

// GPIO lines
///unsigned int (*line_offset)(struct gpiod_line *line);
typedef line_offset_native_t = Int32 Function(Pointer<gpiod_line> line);
...
typedef line_is_used_native_t = bool Function(Pointer<gpiod_line> line);
///bool (*line_is_open_drain)(struct gpiod_line *line);
typedef line_is_open_drain_native_t = bool Function(Pointer<gpiod_line> line);
///bool (*line_is_open_source)(struct gpiod_line *line);
typedef line_is_open_source_native_t = bool Function(Pointer<gpiod_line> line);
...
typedef line_request_native_t = Int32 Function(Pointer<gpiod_line> line, Pointer<gpiod_line_request_config> config, Int32 default_val);
...
typedef line_is_requested_native_t = bool Function(Pointer<gpiod_line> line);
///bool (*line_is_free)(struct gpiod_line *line);
typedef line_is_free_native_t = bool Function(Pointer<gpiod_line> line);
...
typedef line_event_wait_bulk_native_t = Int32 Function(Pointer<gpiod_line_bulk> bulk, Pointer<timespec> timeout, Pointer<gpiod_line_bulk> event_bulk);
