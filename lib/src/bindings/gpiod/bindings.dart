...
class GPIOD {
  ...
  late int Function(Pointer<gpiod_line_bulk> bulk, Pointer<timespec> timeout, Pointer<gpiod_line_bulk> event_bulk)
      line_event_wait_bulk;
  ...
  GPIOD._internal() {
    ...
    chip_num_lines =
        _dynamicLibrary.lookup<NativeFunction<chip_num_lines_native_t>>("gpiod_chip_num_lines").asFunction();

    chip_iter_new = _dynamicLibrary.lookup<NativeFunction<chip_iter_new_native_t>>("gpiod_chip_iter_new").asFunction();
    chip_iter_free_noclose = _dynamicLibrary
        .lookup<NativeFunction<chip_iter_free_noclose_native_t>>('gpiod_chip_iter_free_noclose')
        .asFunction();
    chip_iter_next_noclose = _dynamicLibrary
        .lookup<NativeFunction<chip_iter_next_noclose_native_t>>('gpiod_chip_iter_next_noclose')
        .asFunction();
    ...
    line_direction =
        _dynamicLibrary.lookup<NativeFunction<line_direction_native_t>>("gpiod_line_direction").asFunction();
    line_active_state =
        _dynamicLibrary.lookup<NativeFunction<line_active_state_native_t>>("gpiod_line_active_state").asFunction();
    try {
    ...
    line_is_open_drain =
        _dynamicLibrary.lookup<NativeFunction<line_is_open_drain_native_t>>("gpiod_line_is_open_drain").asFunction();
    line_is_open_source =
        _dynamicLibrary.lookup<NativeFunction<line_is_open_source_native_t>>("gpiod_line_is_open_source").asFunction();
    ...
    line_is_requested =
        _dynamicLibrary.lookup<NativeFunction<line_is_requested_native_t>>("gpiod_line_is_requested").asFunction();
    line_is_free = _dynamicLibrary.lookup<NativeFunction<line_is_free_native_t>>("gpiod_line_is_free").asFunction();
    line_get_value =
        _dynamicLibrary.lookup<NativeFunction<line_get_value_native_t>>("gpiod_line_get_value").asFunction();
    line_set_value =
        _dynamicLibrary.lookup<NativeFunction<line_set_value_native_t>>("gpiod_line_set_value").asFunction();
    try {
      line_set_config =
    ...
    line_event_wait_bulk = _dynamicLibrary
        .lookup<NativeFunction<line_event_wait_bulk_native_t>>("gpiod_line_event_wait_bulk")
        .asFunction();
    line_event_read =
        _dynamicLibrary.lookup<NativeFunction<line_event_read_native_t>>("gpiod_line_event_read").asFunction();
    line_event_get_fd =
        _dynamicLibrary.lookup<NativeFunction<line_event_get_fd_native_t>>("gpiod_line_event_get_fd").asFunction();
    ...
    line_iter_free =
        _dynamicLibrary.lookup<NativeFunction<line_iter_free_native_t>>("gpiod_line_iter_free").asFunction();
    line_iter_next =
        _dynamicLibrary.lookup<NativeFunction<line_iter_next_native_t>>("gpiod_line_iter_next").asFunction();

    // misc
    version_string =
        _dynamicLibrary.lookup<NativeFunction<version_string_native_t>>("gpiod_version_string").asFunction();
  }
